...
# ASN.1 source file://d:\Devices\MIKROTIK.mib
# Produced by pysmi-0.3.1 at Tue Oct  9 16:56:55 2018
# On host ? platform ? version ? by user ?
# Using Python version 2.7.15 (v2.7.15:ca079a3ea3, Apr 30 2018, 16:30:26) [MSC v.1500 64 bit (AMD64)]
#
...
mikrotikExperimentalModule.setRevisions(('2018-07-31 00:00',))
if mibBuilder.loadTexts: mikrotikExperimentalModule.setLastUpdated('201807310000Z')
...
mtxrWl60GMode = MibTableColumn((1, 3, 6, 1, 4, 1, 14988, 1, 1, 1, 8, 1, 2), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1, 2, 3)).clone(namedValues=NamedValues(("apBridge", 0), ("stationBridge", 1), ("sniff", 2), ("bridge", 3)))).setMaxAccess("readonly")
...
mtxrWl60GRxSector = MibTableColumn((1, 3, 6, 1, 4, 1, 14988, 1, 1, 1, 8, 1, 10), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: mtxrWl60GRxSector.setStatus('current')
...
mtxrWl60GStaRxSector = MibTableColumn((1, 3, 6, 1, 4, 1, 14988, 1, 1, 1, 9, 1, 7), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: mtxrWl60GStaRxSector.setStatus('current')
...
mtxrPOEStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 14988, 1, 1, 15, 1, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4)).clone(namedValues=NamedValues(("disabled", 1), ("waitingForLoad", 2), ("poweredOn", 3), ("overload", 4)))).setMaxAccess("readonly")
...
mtxrLTEModemAccessTechnology = MibTableColumn((1, 3, 6, 1, 4, 1, 14988, 1, 1, 16, 1, 1, 6), Integer32().subtype(subtypeSpec=SingleValueConstraint(-1, 0, 1, 2, 3, 4, 5, 6, 7)).clone(namedValues=NamedValues(("unknown", -1), ("gsmcompact", 0), ("gsm", 1), ("utran", 2), ("egprs", 3), ("hsdpa", 4), ("hsupa", 5), ("hsdpahsupa", 6), ("eutran", 7)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("MIKROTIK-MIB", mtxrInterfaceStatsRxAlignError=mtxrInterfaceStatsRxAlignError, mtxrInterfaceStats=mtxrInterfaceStats, mtxrTemperatureException=mtxrTemperatureException, mtxrQueues=mtxrQueues, mtxrQueueSimpleBytesOut=mtxrQueueSimpleBytesOut, mtxrWlCMState=mtxrWlCMState, mtxrHlSensorTemperature=mtxrHlSensorTemperature, mtxrLTEModemAccessTechnology=mtxrLTEModemAccessTechnology, mtxrLongtitude=mtxrLongtitude, mtxrWlStatStrength=mtxrWlStatStrength, mtxrInterfaceStatsTxFCSError=mtxrInterfaceStatsTxFCSError, mtxrInterfaceStatsTxDrop=mtxrInterfaceStatsTxDrop, mtxrOpticalGroup=mtxrOpticalGroup, mtxrTrapGroup=mtxrTrapGroup, mtxrNstremeDualGroup=mtxrNstremeDualGroup, Temperature=Temperature, mtxrWlRtabSignalToNoise=mtxrWlRtabSignalToNoise, mtxrWl60GSignal=mtxrWl60GSignal, mtxrWirelessModem=mtxrWirelessModem, ObjectIndex=ObjectIndex, mtxrWlCMRtabTable=mtxrWlCMRtabTable, mtxrInterfaceStatsRx1519ToMax=mtxrInterfaceStatsRx1519ToMax, mtxrOpticalSupplyVoltage=mtxrOpticalSupplyVoltage, mtxrInterfaceStatsTxPackets=mtxrInterfaceStatsTxPackets, mtxrHotspotActiveUserPacketsOut=mtxrHotspotActiveUserPacketsOut, mtxrInterfaceStatsRxFragment=mtxrInterfaceStatsRxFragment, mtxrWirelessModemGroup=mtxrWirelessModemGroup, mtxrInterfaceStatsTxBytes=mtxrInterfaceStatsTxBytes, mtxrInterfaceStatsRxCarrierError=mtxrInterfaceStatsRxCarrierError, mtxrWl60GConnected=mtxrWl60GConnected, mtxrLTEModemInterfaceIndex=mtxrLTEModemInterfaceIndex, mtxrOpticalTxBiasCurrent=mtxrOpticalTxBiasCurrent, mtxrWlCMTable=mtxrWlCMTable, mtxrQueueSimpleEntry=mtxrQueueSimpleEntry, mtxrQueueGroup=mtxrQueueGroup, mtxrWlStatTxRate=mtxrWlStatTxRate, mtxrDnStatIndex=mtxrDnStatIndex, mtxrHlCpuTemperature=mtxrHlCpuTemperature, mtxrWlCMRtabAddr=mtxrWlCMRtabAddr, mtxrInterfaceStatsTx64=mtxrInterfaceStatsTx64, mtxrInterfaceStatsTxRx1024To1518=mtxrInterfaceStatsTxRx1024To1518, mtxrHealth=mtxrHealth, PYSNMP_MODULE_ID=mikrotikExperimentalModule, mtxrHotspotActiveUserAdvertStatus=mtxrHotspotActiveUserAdvertStatus, mtxrInterfaceStatsDriverRxPackets=mtxrInterfaceStatsDriverRxPackets, mtxrAltitude=mtxrAltitude, mtxrInterfaceStatsRx512To1023=mtxrInterfaceStatsRx512To1023, mtxrQueueTreePCQQueues=mtxrQueueTreePCQQueues, mtxrWlCMAuthClientCount=mtxrWlCMAuthClientCount, mtxrOpticalTxPower=mtxrOpticalTxPower, mtxrWlCMRemoteAddress=mtxrWlCMRemoteAddress, mtxrInterfaceStatsEntry=mtxrInterfaceStatsEntry, mtxrHotspotActiveUserPacketsIn=mtxrHotspotActiveUserPacketsIn, mtxrLTEModemTable=mtxrLTEModemTable, mtxrHotspot=mtxrHotspot, mtxrWl60GStaTxSector=mtxrWl60GStaTxSector, mtxrWlApClientCount=mtxrWlApClientCount, mtxrWl60GStaRssi=mtxrWl60GStaRssi, mtxrWlRtabTxRate=mtxrWlRtabTxRate, mtxrHotspotActiveUsersTableEntry=mtxrHotspotActiveUsersTableEntry, mtxrWlCMRtabTxPackets=mtxrWlCMRtabTxPackets, mtxrInterfaceStatsTxControl=mtxrInterfaceStatsTxControl, mtxrInterfaceStatsTxRx512To1023=mtxrInterfaceStatsTxRx512To1023, mtxrLatitude=mtxrLatitude, mtxrSattelites=mtxrSattelites, mtxrWlRtabTxStrengthCh0=mtxrWlRtabTxStrengthCh0, mtxrWl60GStaRxSector=mtxrWl60GStaRxSector, mtxrInterfaceStatsTxRx1519ToMax=mtxrInterfaceStatsTxRx1519ToMax, mtxrWlRtabUptime=mtxrWlRtabUptime, mtxrPOEGroup=mtxrPOEGroup, mtxrWlCMRtabRxStrength=mtxrWlCMRtabRxStrength, mtxrScriptName=mtxrScriptName, mtxrWlRtabAddr=mtxrWlRtabAddr, mtxrQueueTreeHCBytes=mtxrQueueTreeHCBytes, mtxrInterfaceStatsTx1519ToMax=mtxrInterfaceStatsTx1519ToMax, mtxrOpticalRxLoss=mtxrOpticalRxLoss, mtxrInterfaceStatsTxRx65To127=mtxrInterfaceStatsTxRx65To127, mtxrLTEModemCellId=mtxrLTEModemCellId, mtxrPartitionSize=mtxrPartitionSize, mtxrDnConnected=mtxrDnConnected, mtxrWl60GFreq=mtxrWl60GFreq, mtxrPartitionIndex=mtxrPartitionIndex, mtxrLicSoftwareId=mtxrLicSoftwareId, mtxrPOE=mtxrPOE, mtxrTraps=mtxrTraps, mtxrInterfaceStatsTxPause=mtxrInterfaceStatsTxPause, mtxrWlStatRxRate=mtxrWlStatRxRate, mtxrInterfaceStatsRx128To255=mtxrInterfaceStatsRx128To255, mtxrHotspotActiveUserDomain=mtxrHotspotActiveUserDomain, mtxrOpticalTable=mtxrOpticalTable, mtxrWlRtabRouterOSVersion=mtxrWlRtabRouterOSVersion, mtxrWlApOverallTxCCQ=mtxrWlApOverallTxCCQ, mtxrWlCMRemoteTable=mtxrWlCMRemoteTable, mtxrWl60GStaMcs=mtxrWl60GStaMcs, mtxrLicVersion=mtxrLicVersion, mtxrLicense=mtxrLicense, mtxrQueueSimplePacketsOut=mtxrQueueSimplePacketsOut, mtxrPartitionName=mtxrPartitionName, mtxrHlActiveFan=mtxrHlActiveFan, Power=Power, mtxrInterfaceStatsTxMulticast=mtxrInterfaceStatsTxMulticast, mtxrScriptRunIndex=mtxrScriptRunIndex, mtxrQueueTreeDropped=mtxrQueueTreeDropped, mtxrNeighborPlatform=mtxrNeighborPlatform, mtxrInterfaceStatsTable=mtxrInterfaceStatsTable, mtxrWlRtabIface=mtxrWlRtabIface, mtxrWlCMRtabEntry=mtxrWlCMRtabEntry, mtxrHotspotActiveUserIndex=mtxrHotspotActiveUserIndex, mtxrQueueSimpleSrcMask=mtxrQueueSimpleSrcMask, mtxrWlRtabTxStrengthCh2=mtxrWlRtabTxStrengthCh2, mtxrWlRtabTxStrengthCh1=mtxrWlRtabTxStrengthCh1, mtxrHotspotActiveUserLimitBytesOut=mtxrHotspotActiveUserLimitBytesOut, mtxrSystemReboot=mtxrSystemReboot, Voltage=Voltage, mtxrDHCP=mtxrDHCP, mtxrBoardName=mtxrBoardName, mikrotik=mikrotik, mtxrWlCMREntryCount=mtxrWlCMREntryCount, mtxrNotifications=mtxrNotifications, mtxrWirelessGroup=mtxrWirelessGroup, mtxrWlCMRemoteIndex=mtxrWlCMRemoteIndex, mtxrWlRtabTable=mtxrWlRtabTable, mtxrQueueTreeBytes=mtxrQueueTreeBytes, mtxrWl60GMcs=mtxrWl60GMcs, mtxrQueueSimplePCQQueuesIn=mtxrQueueSimplePCQQueuesIn, mtxrQueueTreeName=mtxrQueueTreeName, mtxrHlProcessorFrequency=mtxrHlProcessorFrequency, mtxrWlApSsid=mtxrWlApSsid, mtxrInterfaceStatsIndex=mtxrInterfaceStatsIndex, mtXRouterOs=mtXRouterOs, mtxrWl60GStaRemote=mtxrWl60GStaRemote, mtxrQueueSimpleName=mtxrQueueSimpleName, mtxrInterfaceStatsTxExcessiveCollision=mtxrInterfaceStatsTxExcessiveCollision, mtxrInterfaceStatsTx512To1023=mtxrInterfaceStatsTx512To1023, mtxrLTEModemGroup=mtxrLTEModemGroup, mtxrWl60GStaConnected=mtxrWl60GStaConnected, mtxrDnStatRxRate=mtxrDnStatRxRate, mtxrHlTwelveVoltage=mtxrHlTwelveVoltage, mtxrWlApTxRate=mtxrWlApTxRate, mtxrWlCMRtabTxStrength=mtxrWlCMRtabTxStrength, mtxrInterfaceStatsRxControl=mtxrInterfaceStatsRxControl, mtxrHlCurrent=mtxrHlCurrent, mtxrInterfaceStatsTxBroadcast=mtxrInterfaceStatsTxBroadcast, mtxrHotspotActiveUserServerID=mtxrHotspotActiveUserServerID, mtxrScriptTable=mtxrScriptTable, mtxrHotspotActiveUserMAC=mtxrHotspotActiveUserMAC, mtxrWl60GIndex=mtxrWl60GIndex, mtxrLicLevel=mtxrLicLevel, mtxrSystemGroup=mtxrSystemGroup, mtxrWlStatFreq=mtxrWlStatFreq, mtxrNeighborSoftwareID=mtxrNeighborSoftwareID, mtxrInterfaceStatsTxExcessiveDeferred=mtxrInterfaceStatsTxExcessiveDeferred, mtxrLTEModemSignalRSRP=mtxrLTEModemSignalRSRP, mtxrNeighborIpAddress=mtxrNeighborIpAddress, mtxrNeighborTable=mtxrNeighborTable, mtxrWlCMRemoteRadios=mtxrWlCMRemoteRadios, mtxrHotspotActiveUserConnectTime=mtxrHotspotActiveUserConnectTime, GDiv1000=GDiv1000, mtxrQueueTreeParentIndex=mtxrQueueTreeParentIndex, mtxrNeighborIndex=mtxrNeighborIndex, mtxrInterfaceStatsTxRx128To255=mtxrInterfaceStatsTxRx128To255, mtxrWl60GStaEntry=mtxrWl60GStaEntry, mtxrPOETable=mtxrPOETable, BoolValue=BoolValue, mtxrInterfaceStatsRxPause=mtxrInterfaceStatsRxPause, mtxrLicUpgrUntil=mtxrLicUpgrUntil, mtxrInterfaceStatsRx1024To1518=mtxrInterfaceStatsRx1024To1518, mtxrInterfaceStatsRxDrop=mtxrInterfaceStatsRxDrop, mtxrFirmwareVersion=mtxrFirmwareVersion, mtxrWlApNoiseFloor=mtxrWlApNoiseFloor, mtxrLicUpgradableTo=mtxrLicUpgradableTo, mtxrWl60GStaDistance=mtxrWl60GStaDistance, mtxrWl60GEntry=mtxrWl60GEntry, mtxrInterfaceStatsTx128To255=mtxrInterfaceStatsTx128To255, mtxrWlApEntry=mtxrWlApEntry, mtxrSystem=mtxrSystem, mtxrInterfaceStatsDriverTxBytes=mtxrInterfaceStatsDriverTxBytes, mtxrHlProcessorTemperature=mtxrHlProcessorTemperature, mtxrNeighbor=mtxrNeighbor, mtxrQueueSimpleTable=mtxrQueueSimpleTable, mtxrInterfaceStatsRxBytes=mtxrInterfaceStatsRxBytes, mtxrDnStatRxStrength=mtxrDnStatRxStrength, mtxrWlRtabTxStrength=mtxrWlRtabTxStrength, mtxrWlApTable=mtxrWlApTable, mtxrWl60GRssi=mtxrWl60GRssi, mtxrHotspotActiveUserIdleStartTime=mtxrHotspotActiveUserIdleStartTime, mtxrPartitionTable=mtxrPartitionTable, mtxrNeighborMacAddress=mtxrNeighborMacAddress, mtxrInterfaceStatsRx65To127=mtxrInterfaceStatsRx65To127, mtxrInterfaceStatsGroup=mtxrInterfaceStatsGroup, mtxrNeighborVersion=mtxrNeighborVersion, mtxrOptical=mtxrOptical, mtxrWl60GTxSectorInfo=mtxrWl60GTxSectorInfo, mtxrHotspotActiveUserIdleTimeout=mtxrHotspotActiveUserIdleTimeout, mtxrInterfaceStatsRxJabber=mtxrInterfaceStatsRxJabber, mtxrInterfaceStatsTx1024To1518=mtxrInterfaceStatsTx1024To1518, mtxrSerialNumber=mtxrSerialNumber, mtxrScriptRun=mtxrScriptRun, mtxrHealthGroup=mtxrHealthGroup, mtxrLTEModemSignalSINR=mtxrLTEModemSignalSINR, mtxrInterfaceStatsTxTotalCollision=mtxrInterfaceStatsTxTotalCollision, mtxrLTEModemSignalRSRQ=mtxrLTEModemSignalRSRQ, mtxrWlApRxRate=mtxrWlApRxRate, mtxrDnStatTable=mtxrDnStatTable, mtxrFirmwareUpgradeVersion=mtxrFirmwareUpgradeVersion, mtxrDate=mtxrDate, mikrotikExperimentalModule=mikrotikExperimentalModule, mtxrScriptRunGroup=mtxrScriptRunGroup, GDiv100=GDiv100, mtxrWlCMRemoteEntry=mtxrWlCMRemoteEntry, mtxrHlTemperature=mtxrHlTemperature, mtxrInterfaceStatsRxTooLong=mtxrInterfaceStatsRxTooLong, mtxrNeighborTableEntry=mtxrNeighborTableEntry, mtxrInterfaceStatsTxTooShort=mtxrInterfaceStatsTxTooShort, mtxrHlPowerSupplyState=mtxrHlPowerSupplyState, mtxrSpeed=mtxrSpeed, mtxrWlCMRtabTxRate=mtxrWlCMRtabTxRate, mtxrInterfaceStatsRxOverflow=mtxrInterfaceStatsRxOverflow, mtxrPOEStatus=mtxrPOEStatus, mtxrWlCMRtabUptime=mtxrWlCMRtabUptime, mtxrWl60GStaIndex=mtxrWl60GStaIndex, mtxrWireless=mtxrWireless, mtxrInterfaceStatsRxBroadcast=mtxrInterfaceStatsRxBroadcast, mtxrWl60GRemote=mtxrWl60GRemote, mtXMetaInfo=mtXMetaInfo, mtxrWlCMRtabSsid=mtxrWlCMRtabSsid, mtxrWlCMChannel=mtxrWlCMChannel, mtxrInterfaceStatsRx256To511=mtxrInterfaceStatsRx256To511, mtxrInterfaceStatsRx64=mtxrInterfaceStatsRx64, mtxrPOEName=mtxrPOEName, mtxrQueueSimpleDstMask=mtxrQueueSimpleDstMask, mtxrHotspotActiveUserPingTimeout=mtxrHotspotActiveUserPingTimeout, mtxrWirelessModemSignalStrength=mtxrWirelessModemSignalStrength, mtxrDnStatTxStrength=mtxrDnStatTxStrength, mtxrScriptRunOutput=mtxrScriptRunOutput, mtxrLTEModemSignalRSSI=mtxrLTEModemSignalRSSI, mtxrWlRtabStrength=mtxrWlRtabStrength, mtxrWl60GSsid=mtxrWl60GSsid, mtxrScriptRunTableEntry=mtxrScriptRunTableEntry, mtxrGPSGroup=mtxrGPSGroup, mtxrInterfaceStatsTxSingleCollision=mtxrInterfaceStatsTxSingleCollision, mtxrWlRtabRxStrengthCh0=mtxrWlRtabRxStrengthCh0, mtxrHlPower=mtxrHlPower, mtxrInterfaceStatsTxRx64=mtxrInterfaceStatsTxRx64, mtxrWlCMRtabRxPackets=mtxrWlCMRtabRxPackets, mtxrInterfaceStatsDriverTxPackets=mtxrInterfaceStatsDriverTxPackets, mtxrWlCMRegClientCount=mtxrWlCMRegClientCount, mtxrWl60GStaTable=mtxrWl60GStaTable, mtxrLTEModemEntry=mtxrLTEModemEntry, mtxrPOEInterfaceIndex=mtxrPOEInterfaceIndex, mtxrNstremeDual=mtxrNstremeDual, mtxrScriptRunCmd=mtxrScriptRunCmd, mtxrOpticalTemperature=mtxrOpticalTemperature, mtxrHotspotActiveUserGroup=mtxrHotspotActiveUserGroup)
mibBuilder.exportSymbols("MIKROTIK-MIB", mtxrWlStatBand=mtxrWlStatBand, mtxrInterfaceStatsTxTooLong=mtxrInterfaceStatsTxTooLong, mtxrWlCMRemoteState=mtxrWlCMRemoteState, mtxrInterfaceStatsRxTooShort=mtxrInterfaceStatsRxTooShort, mtxrWlCMRtabRxBytes=mtxrWlCMRtabRxBytes, mtxrWlApFreq=mtxrWlApFreq, mtxrWl60GMode=mtxrWl60GMode, mtxrInterfaceStatsTxFragment=mtxrInterfaceStatsTxFragment, mtxrHlCoreVoltage=mtxrHlCoreVoltage, mtxrNeighborIdentity=mtxrNeighborIdentity, mtxrPartitionRunning=mtxrPartitionRunning, mtxrWlRtabRxPackets=mtxrWlRtabRxPackets, mtxrWlRtabRxStrengthCh2=mtxrWlRtabRxStrengthCh2, mtxrScriptTableEntry=mtxrScriptTableEntry, mtxrQueueSimpleDroppedIn=mtxrQueueSimpleDroppedIn, HexInt=HexInt, mtxrQueueSimpleSrcAddr=mtxrQueueSimpleSrcAddr, mtxrNeighborGroup=mtxrNeighborGroup, mtxrScriptGroup=mtxrScriptGroup, mtxrInterfaceStatsName=mtxrInterfaceStatsName, mtxrHotspotActiveUserIP=mtxrHotspotActiveUserIP, mtxrHlVoltage=mtxrHlVoltage, mtxrQueueTreeFlow=mtxrQueueTreeFlow, mtxrHotspotActiveUserBytesIn=mtxrHotspotActiveUserBytesIn, mtxrWlApAuthClientCount=mtxrWlApAuthClientCount, mtxrInterfaceStatsTxDeferred=mtxrInterfaceStatsTxDeferred, mtxrWlStatBssid=mtxrWlStatBssid, mtxrWlRtabTxBytes=mtxrWlRtabTxBytes, mtxrDHCPGroup=mtxrDHCPGroup, mtxrHlBackupPowerSupplyState=mtxrHlBackupPowerSupplyState, mtxrOpticalTableEntry=mtxrOpticalTableEntry, mtxrQueueSimplePacketsIn=mtxrQueueSimplePacketsIn, mtxrInterfaceStatsTxLateCollision=mtxrInterfaceStatsTxLateCollision, IDiv1000=IDiv1000, mtxrOpticalWavelength=mtxrOpticalWavelength, mtxrInterfaceStatsTxMultipleCollision=mtxrInterfaceStatsTxMultipleCollision, mtxrLincenseGroup=mtxrLincenseGroup, mtxrWl60GRxSector=mtxrWl60GRxSector, mtxrWl60GTable=mtxrWl60GTable, mtxrInterfaceStatsTxJabber=mtxrInterfaceStatsTxJabber, mtxrPOEPower=mtxrPOEPower, mtxrInterfaceStatsRxMulticast=mtxrInterfaceStatsRxMulticast, mtxrQueueSimpleDroppedOut=mtxrQueueSimpleDroppedOut, mtxrWlApBssid=mtxrWlApBssid, mtxrQueueSimplePCQQueuesOut=mtxrQueueSimplePCQQueuesOut, mtxrInterfaceStatsRxFCSError=mtxrInterfaceStatsRxFCSError, mtxrWlRtabRxBytes=mtxrWlRtabRxBytes, mtxrWlCMRtabEntryCount=mtxrWlCMRtabEntryCount, mtxrDHCPLeaseCount=mtxrDHCPLeaseCount, mtxrTrap=mtxrTrap, mtxrWlCMRtabTxBytes=mtxrWlCMRtabTxBytes, mtxrWlStatIndex=mtxrWlStatIndex, mtxrOpticalRxPower=mtxrOpticalRxPower, mtxrHotspotActiveUserBlockedByAdvert=mtxrHotspotActiveUserBlockedByAdvert, mtxrPartitionGroup=mtxrPartitionGroup, mtxrWirelessModemSignalECIO=mtxrWirelessModemSignalECIO, mtxrValid=mtxrValid, mtxrPOECurrent=mtxrPOECurrent, mtxrDnStatTxRate=mtxrDnStatTxRate, mtxrBuildTime=mtxrBuildTime, mtxrPartitionEntry=mtxrPartitionEntry, mtxrQueueTreeTable=mtxrQueueTreeTable, mtxrHotspotActiveUserLimitBytesIn=mtxrHotspotActiveUserLimitBytesIn, mtxrWl60GStaPhyRate=mtxrWl60GStaPhyRate, mtxrPartitionActive=mtxrPartitionActive, mtxrLTEModem=mtxrLTEModem, mtxrWlApIndex=mtxrWlApIndex, mtxrInterfaceStatsRxLengthError=mtxrInterfaceStatsRxLengthError, mtxrWlRtabRxRate=mtxrWlRtabRxRate, mtxrWlCMRtabRxRate=mtxrWlCMRtabRxRate, mtxrWlCMIndex=mtxrWlCMIndex, mtxrHotspotActiveUserRadius=mtxrHotspotActiveUserRadius, mtxrOpticalTxFault=mtxrOpticalTxFault, mtXRouterOsGroups=mtXRouterOsGroups, mtxrScriptIndex=mtxrScriptIndex, mtxrInterfaceStatsTxRx256To511=mtxrInterfaceStatsTxRx256To511, mtxrHlThreeDotThreeVoltage=mtxrHlThreeDotThreeVoltage, mtxrOpticalName=mtxrOpticalName, mtxrWlRtabTxPackets=mtxrWlRtabTxPackets, mtxrHotspotActiveUserBytesOut=mtxrHotspotActiveUserBytesOut, mtxrHlFiveVoltage=mtxrHlFiveVoltage, mtxrHlBoardTemperature=mtxrHlBoardTemperature, mtxrOpticalIndex=mtxrOpticalIndex, mtxrDnStatEntry=mtxrDnStatEntry, mtxrInterfaceStatsTx65To127=mtxrInterfaceStatsTx65To127, mtxrInterfaceStatsRxCodeError=mtxrInterfaceStatsRxCodeError, mtxrWlRtabEntry=mtxrWlRtabEntry, mtxrWlCMRemoteName=mtxrWlCMRemoteName, mtxrPartitionVersion=mtxrPartitionVersion, mtxrHotspotActiveUsersTable=mtxrHotspotActiveUsersTable, mtxrQueueSimpleDstAddr=mtxrQueueSimpleDstAddr, mtxrInterfaceStatsTx256To511=mtxrInterfaceStatsTx256To511, mtxrNeighborInterfaceID=mtxrNeighborInterfaceID, mtxrInterfaceStatsTxUnderrun=mtxrInterfaceStatsTxUnderrun, mtxrWlStatSsid=mtxrWlStatSsid, mtxrWlRtabRxStrengthCh1=mtxrWlRtabRxStrengthCh1, mtxrQueueSimpleIndex=mtxrQueueSimpleIndex, mtxrScriptRunTable=mtxrScriptRunTable, mtxrInterfaceStatsRxPackets=mtxrInterfaceStatsRxPackets, mtxrUSBPowerReset=mtxrUSBPowerReset, mtxrWlApBand=mtxrWlApBand, mtxrWl60GStaSignal=mtxrWl60GStaSignal, mtxrInterfaceStatsRxUnknownOp=mtxrInterfaceStatsRxUnknownOp, mtxrPOEEntry=mtxrPOEEntry, mtxrGps=mtxrGps, mtxrQueueTreePackets=mtxrQueueTreePackets, mtxrNote=mtxrNote, mtxrHotspotActiveUserName=mtxrHotspotActiveUserName, mtxrHlFanSpeed1=mtxrHlFanSpeed1, mtxrWlCMEntry=mtxrWlCMEntry, mtxrWlCMRtabIface=mtxrWlCMRtabIface, mtxrWl60GTxSector=mtxrWl60GTxSector, mtxrPartition=mtxrPartition, mtxrQueueSimpleIface=mtxrQueueSimpleIface, mtxrWlRtabEntryCount=mtxrWlRtabEntryCount, mtxrQueueTreeEntry=mtxrQueueTreeEntry, mtxrWlStatEntry=mtxrWlStatEntry, mtxrScripts=mtxrScripts, mtxrInterfaceStatsTxPauseHonored=mtxrInterfaceStatsTxPauseHonored, mtxrHotspotActiveUserValidTillTime=mtxrHotspotActiveUserValidTillTime, mtxrHlFanSpeed2=mtxrHlFanSpeed2, mtxrPOEVoltage=mtxrPOEVoltage, mtxrQueueTreeIndex=mtxrQueueTreeIndex, mtxrWlStatTable=mtxrWlStatTable, mtxrInterfaceStatsDriverRxBytes=mtxrInterfaceStatsDriverRxBytes, mtxrInterfaceStatsTxCollision=mtxrInterfaceStatsTxCollision, mtxrQueueSimpleBytesIn=mtxrQueueSimpleBytesIn)
